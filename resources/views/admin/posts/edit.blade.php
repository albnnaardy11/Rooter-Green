            ...
            <div class="bg-slate-900/50 p-8 sm:p-12 rounded-[3rem] border border-white/5 backdrop-blur-xl space-y-8">
                ...
                <div>
                    ...
                    <textarea name="content" rows="12" required placeholder="Write your article content here..." 
                              class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder-slate-600 focus:outline-none focus:border-primary/50 transition-all font-medium leading-relaxed">{{ old('content', $post->content) }}</textarea>
